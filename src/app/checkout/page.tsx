          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <section className="bg-white p-6 md:p-8 border border-gray-200">
              <h2 className="text-lg font-bold text-[var(--color-brand-dark)] mb-6 flex items-center uppercase tracking-widest">
                <User className="w-5 h-5 mr-3 text-[var(--color-brand-gold)]" />
                Dados Pessoais
              </h2>
            ...
            <section className="bg-white p-6 md:p-8 border border-gray-200">
              ...
              {shippingOptions.length === 0 ? (
                ...
                <div className="space-y-4">
                  {hasMadeToOrder && (
                    <div className="flex items-start gap-2 text-amber-700 bg-amber-50 p-4 rounded-sm border border-amber-200 mb-6">
                      <AlertCircle className="w-5 h-5 shrink-0 mt-0.5" />
                      <p className="text-sm">
                        <strong className="font-semibold">Atenção:</strong> Seu pedido contém peças sob encomenda (+{maxProductionDays} dias úteis de confecção já inclusos no prazo final das opções abaixo).
                      </p>
                    </div>
                  )}
